...
class InMemoryOrderRepositoryTest {
    ...
    void setUp() {
        ...
        sampleOrder = new Order("OR1", LocalDateTime.now(), sampleCustomer, List.of(cartItem), new BigDecimal("99.98"));
    }
    ...
    void shouldOverwriteOrderWhenSavingWithSameId() {
        ...
        Order updatedOrder = new Order("OR1", LocalDateTime.now(), sampleCustomer, List.of(otherItem), new BigDecimal("29.99"));
    ...
    void shouldReturnAllSavedOrders() {
        ...
        Electronics cable = new Electronics("E2", "HDMI Cable", new BigDecimal("29.99"), 50);
        CartItem otherItem = cable.toCartItem(new NoConfiguration(), 1);
        Order secondOrder = new Order("OR2", LocalDateTime.now(), sampleCustomer, List.of(otherItem), new BigDecimal("29.99"));
